resource "openstack_networking_secgroup_v2" "secgroup_red_proxy" {
  name        = "secgroup_red_proxy"
}

resource "openstack_networking_secgroup_rule_v2" "secgroup_red_proxy_rule_1" {
  direction         = "ingress"
  ethertype         = "IPv4"
  #protocol          = ""
  #port_range_min    = 0
  ...
  #remote_group_id   = ""
  security_group_id = openstack_networking_secgroup_v2.secgroup_red_proxy.id
}

resource "openstack_networking_secgroup_rule_v2" "secgroup_red_proxy_rule_2" {
  direction         = "ingress"
  ethertype         = "IPv6"
  #protocol          = ""
  #port_range_min    = 0
...
/*
resource "openstack_networking_secgroup_rule_v2" "secgroup_red_proxy_rule_3" {
  direction         = "egress"
  ethertype         = "IPv4"
  #protocol          = ""
  #port_range_min    = 0
...
resource "openstack_networking_secgroup_rule_v2" "secgroup_red_proxy_rule_4" {
  direction         = "egress"
  ethertype         = "IPv6"
  #protocol          = ""
  #port_range_min    = 0
