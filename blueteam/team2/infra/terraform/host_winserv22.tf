resource "openstack_compute_instance_v2" "winserv22_2" {
  depends_on = [openstack_networking_secgroup_v2.secgroup_inscope2]
  for_each = var.winserv22_2
  ...
  security_groups = ["secgroup_inscope2"]
